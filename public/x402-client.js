var X402Solana = (function (exports) {
  ...
  function ecdsa(Point, hash, ecdsaOpts = {}) {
    ...
    function verify2(signature2, message, publicKey3, opts = {}) {
...
Missing signature for public key${sigErrors.missing.length === 1 ? "" : "(s)"} [\`${sigErrors.missing.map((p) => p.toBase58()).join("`, `")}\`].`;
  ...
  var VersionedTransaction = class _VersionedTransaction {
    ...
    addSignature(publicKey3, signature2) {
      ...
      assert2(signerIndex >= 0, `Can not add signature; \`${publicKey3.toBase58()}\` is not required to sign this transaction`);
...
` + maybeLogsOutput + guideText;
  ...
  async function createSolanaPaymentHeader(wallet, x402Version, paymentRequirements, rpcUrl) {
    ...
    if (!destAtaInfo) {
      throw new Error(
        `Treasury wallet does not have an Associated Token Account for ${paymentRequirements.asset}. The treasury must have an ATA before receiving payments.`
      );
    }
  ...
  function createPaymentFetch(fetchFn, wallet, rpcUrl, maxValue = BigInt(0)) {
    return async (input, init) => {
      ...
      const selectedRequirements = parsedPaymentRequirements.find(
        (req) => req.scheme === "exact" && req.network === "solana"
      );
...
//# sourceMappingURL=browser-client.global.global.js.map
//# sourceMappingURL=browser-client.global.global.js.map
